...
python -m paddle.distributed.launch --gpus 0 \
    tools/train.py \
    --config configs/centerpoint/centerpoint_pillars_016voxel_zw.yml \
    --save_dir outputs/centerpoint_zw \
    --num_workers 2 \
    --save_interval 5
```
...
python tools/pcd_vis_single_frame_demo.py   \
   --model_file outputs/centerpoint_zw/best_model/centerpoint.pdmodel   \
   --params_file outputs/centerpoint_zw/best_model/centerpoint.pdiparams   \
   --lidar_file datasets/zw_anno_0914/KITTI_format/training/velodyne/load1-low-speed_sync_005980.bin   \
