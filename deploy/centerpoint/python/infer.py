...
def parse_result(box3d_lidar, label_preds, scores, name):
    ...
    for box_idx in range(num_bbox3d):
        ...
        if scores[box_idx] < 0:
            continue
        if bbox3d_dims == 9:
            with open(f'result/centerpoint/{name}.txt', "a") as f:
                det_result = "Score: {} Label: {} Box(x_c, y_c, z_c, w, l, h, vec_x, vec_y, -rot): {} {} {} {} {} {} {} {} {}\n".format(scores[box_idx], label_preds[box_idx],
...
def main(args):
    ...
    parse_result(box3d_lidar, label_preds, scores, lidar_file)
